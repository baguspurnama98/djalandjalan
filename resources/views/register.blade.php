        ...
        <div class="wrap-login100 p-l-50 p-r-50 p-t-30 p-b-30" style="width: 600px;">
            <form class="login100-form validate-form" action="{{ url('register') }}" method="POST">
                ...
                <div class="wrap-input100 m-b-10">
                    <input class="input100" type="text" value="{{ old('full_name') }}" name="full_name" placeholder="Nama Lengkap">
                ...
                <div class="wrap-input100 validate-input m-b-15" data-validate="Handphone is required">
                    <input class="input100" type="text" value="{{ old('phone') }}" name="phone" placeholder="No. Handphone">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                ...
                <div class="wrap-input100 validate-input m-b-15" data-validate="Tanggal Lahir is required">
                    <input class="input100" type="text" value="{{ old('birth_day') }}" name="birth_day" placeholder="Tanggal Lahir">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                ...
                <div class="wrap-input100 validate-input m-b-15" data-validate="Handphone is required">
                    ...
                    <input type="radio" value="1" name="gender"> Laki-Laki &emsp;
                    <input type="radio" value="0" name="gender"> Perempuan
                </div>
